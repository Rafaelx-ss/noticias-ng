...
export class UserService {
    ...
    async createUser(user: User): Promise<boolean> {
        try {
            const response = await firstValueFrom(
                this.http.post<User>(`${backend}/api/auth/register`, { name: user.name, email: user.email, password: user.password })
            );
            if (response.success) {
                return true;
            }
    ...
    async updateUser(id: string, user: User): Promise<boolean> {
        try {
            const response = await firstValueFrom(
                this.http.put<User>(`${backend}/api/users/${id}`, user)
            );
            if (response.success) {
                return true;
            }
    ...
    getUserByStatus(status: string): Observable<User> {
        return this.http.get<User>(`${this.apiUrl}/users/status/${status}`);
    }   

    getUserByCreatedAt(created_at: string): Observable<User> {
        return this.http.get<User>(`${this.apiUrl}/users/created_at/${created_at}`);
    }

    getUserByUpdatedAt(updated_at: string): Observable<User> {
        return this.http.get<User>(`${this.apiUrl}/users/updated_at/${updated_at}`);
    }

    getUserByDeletedAt(deleted_at: string): Observable<User> {
        return this.http.get<User>(`${this.apiUrl}/users/deleted_at/${deleted_at}`);
    }

    getUserByIsActive(is_active: boolean): Observable<User> {
        return this.http.get<User>(`${this.apiUrl}/users/is_active/${is_active}`);
    }

    getUserByIsVerified(is_verified: boolean): Observable<User> {
        return this.http.get<User>(`${this.apiUrl}/users/is_verified/${is_verified}`);
    }

    getUserByIsEmailVerified(is_email_verified: boolean): Observable<User> {
        return this.http.get<User>(`${this.apiUrl}/users/is_email_verified/${is_email_verified}`);
    }
}
